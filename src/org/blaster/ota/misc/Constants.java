...
public final class Constants {
    ...
    static final String PROP_BUILD_VERSION = "org.blaster.version";
    static final String PROP_VERSION_CODE = "org.blaster.ota.version_code";
    static final String OTA_URL = "https://raw.githubusercontent.com/PixelBlaster-OS/OTA/master/%s/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/PixelBlaster-OS/OTA/master/changelogs/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "PixelBlaster-Updates/";
}
